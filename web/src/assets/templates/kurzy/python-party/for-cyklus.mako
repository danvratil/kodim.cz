...
<%self:lesson>
  <p>Seznamy a cykly jsou v programování něco jako hrnec a nůž při vaření. Bez nich toho moc neuvaříme a bez cyklů a seznamů si taky moc nezaprogramujeme. Možnosti jak využít cykly jsou nepřeberné. Málokdy narazíte na program, ve kterém by nebyl schovaný nějaký druh cyklu a seznamu. Je proto potřeba si na tyto nástroje zvyknout umět s nimi pořádně zacházet dřív, než se vydáme kamkoliv dál. </p>

  <p>Na konci předchozí kapitoly jsme malinko nakousli takzvaný FOR cyklus, který slouží k procházení seznamů prvek po prvku. FOR cyklus však není jediný způsob jak procházet seznam a později si ukážeme další možnosti.</p>

  <h2>FOR cyklus pod drobnohledem</h2>

  <p>Cyklus FOR v minulé lekci nedostal tolik pozornosti, kolik si zaslouží. Vytvořme si proto modelový příklad, na kterém si ukážeme různá jeho další zákoutí. Začneme se seznamem pohybů na nějakém bankovním účtu.</p>
...
<pre>for trans in transactions:
  ...
  <p>Odsud je již krůček k cyklu, který vypíše jen minusové pohyby, tedy úbytky na účtu.</p>
...
print(sum)
  ...
  <h2>Práce s indexy</h2>
  <p>Občas nechceme cyklem procházet úplně celý seznam, ale chceme některé hodnoty vynechat. </p>
