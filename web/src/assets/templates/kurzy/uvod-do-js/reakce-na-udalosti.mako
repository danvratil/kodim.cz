...
<%self:exercises>
  ...
  <%self:exrc title="Celsius vs Fahrnheit">
    <p>Vytvořte webovou stránku s jedním textovým políčkem, jednom tlačítkem a jedním divem pro výslednou zprávu. Uživatel do políčka zadá teplotu ve stupních Fahrnheita a po stisku tlačítka obdrží výsledek ve stupních Celsia. </p>

    <p>Postup přepočtu stupňů Fahrnheita na stupně Celsia najdete například <a href="https://cs.wikipedia.org/wiki/Stupe%C5%88_Fahrenheita">na České wikipedii</a>.</p>
  </%self:exrc>    
